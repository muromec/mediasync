...
public class ServiceInfo implements DNSListener {
    ...
    *           string describing the service
    */
   public ServiceInfo(String type, String name, int port, int weight,
...
//            case DNSConstants.TYPE_AAAA: // IPv6 FIXME [PJYF Oct 14 2004] This
            ...
            case DNSConstants.TYPE_SRV:
               if (rec.name.equals(getQualifiedName())) {
                  ...
                  // updateRecord(jmdns, now, (DNSRecord)jmdns.cache.get(server,
                  // TYPE_A, CLASS_IN));
                  updateRecord(jmdns, now, (DNSRecord) jmdns.getCache().get(
                        server, DNSConstants.TYPE_A, DNSConstants.CLASS_IN));
               }
               break;
   ...
   public boolean equals(Object obj) {
      return (obj instanceof ServiceInfo)
            && getQualifiedName()
                  .equals(((ServiceInfo) obj).getQualifiedName());
   }
